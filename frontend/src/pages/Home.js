...
export default function Home() {
  ...
  React.useEffect(() => {
    ...
    axios.get(STRINGS.url + "/search/" + search).then((response) => {
      console.log(response);
    });
  }, []);
  ...
  return (
    ...
    <Box component="main" sx={{ flexGrow: 1, p: 3 }} style={{ padding:"24px 10%"}}>
      ...
      <p style={{ position: "relative", width: "inherit", textAlign: "left" }}>
        HARSH
        Vaghasutyausfopjadjsbdgoskidabdsgsfbhaifhsfbawdhsdjvbsejdjovsdifhawecnsdvjseabdaojuvsdrifrbddfsfdddddddddddddddddddddddddddddddddddddddddddddddddddddddsssssssssssssssssssfsdfsefefdsfvxdvcszdfwadeadfzdfsdefawfsef
        <br />
